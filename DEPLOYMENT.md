...
sudo service unicorn_toptal <start|stop|restart>
sudo service sidekiq_toptal <start|stop>
```
...
```
/home/deployer/apps/toptal/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_toptal restart
sudo service sidekiq_toptal stop
sudo service sidekiq_toptal start
```
